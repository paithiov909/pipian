...
pipian is a tiny interface to [CaboCha](https://taku910.github.io/cabocha/); a Japanese dependency structure parser. The main goal of pipian is to implement a CaboCha parser for that XML output.
